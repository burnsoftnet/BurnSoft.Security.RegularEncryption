...
namespace BurnSoft.Security.RegularEncryption.UnitTest
{
    ...
    public class MD5_Test
    {
        ...
        /// <summary>
        /// Defines the test method EncryptMd5Test.
        /// </summary>
        [TestMethod, TestCategory("Encrypt - MD5")]
        public void EncryptMd5Test2()
        {

            string value = BurnSoft.Security.RegularEncryption.MD5.Do.Encrypt(_testText);
            TestContext.WriteLine(value);
            Assert.IsTrue(value.Equals(_testTextVerifymd52));
        }
    }
}
